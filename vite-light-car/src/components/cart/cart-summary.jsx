    ...
    <div className="wi-cart-checkout-wrapper border-grayp-200 top-20 rounded border bg-white p-5 shadow-md lg:sticky">
      ...
      <div className="wi-cart-checkout-proceed mt-8">
        <Link
          to={"/checkout"}
          className={
            "bg-heading sm:text-15px bg-primary flex w-full items-center justify-center rounded px-5 py-3 text-sm font-semibold text-white transition duration-300 hover:bg-opacity-90 focus:outline-none"
          }
        >
