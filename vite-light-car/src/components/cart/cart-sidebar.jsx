        ...
        <div className="border-border-base border-t px-5 pb-5 pt-5 md:px-7 md:pb-6 md:pt-6">
          ...
          <div className="flex flex-col gap-5" onClick={closeDrawer}>
            ...
            <Link
              to={"/checkout"}
              className={cn(
                "bg-heading sm:text-15px bg-primary flex w-full items-center justify-center rounded px-5 py-3 text-sm font-semibold text-white shadow-lg transition duration-300 hover:bg-opacity-90 focus:outline-none",
                {
                  "cursor-not-allowed !bg-[#EEEEEE] !text-black !text-opacity-25 hover:!bg-[#EEEEEE]":
                    isEmpty,
                },
